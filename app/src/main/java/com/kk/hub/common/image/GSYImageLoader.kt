package com.kk.hub.common.image


import android.graphics.Bitmap
import androidx.annotation.UiThread
import com.kk.hub.common.config.GSYImageConst
import java.io.File
...
interface GSYImageLoader {
     ...
     */
    fun isCache(loadOption: GSYLoadOption, extendOption: ExtendedOptions? = null): Boolean
     ...
     * @return File
     */
    fun getLocalCache(loadOption: GSYLoadOption, extendOption: ExtendedOptions? = null): File?
     ...
     * @return Bitmap
     */
    fun getLocalCacheBitmap(loadOption: GSYLoadOption, extendOption: ExtendedOptions? = null): Bitmap?
     ...
     * @return Bitmap
     */
    fun downloadOnly(loadOption: GSYLoadOption, callback: Callback?, extendOption: ExtendedOptions? = null)
