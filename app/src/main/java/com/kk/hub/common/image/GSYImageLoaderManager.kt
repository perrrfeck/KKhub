 ...
 */
class GSYImageLoaderManager
private constructor(private var mImageLoader: GSYImageLoader) : GSYImageLoader by mImageLoader {
    ...
    companion object {
        ...
        fun initialize(imageLoader: GSYImageLoader) {
            sInstance =
                GSYImageLoaderManager(imageLoader)
        }
    }
