...
/**
 * Created by kk on 2019/10/31  10:14
 * 页面信息提取拦截 在response添加一个header:page_info
 */
class PageInfoInterceptor : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        return response.newBuilder().addHeader(
            "page_info", GsonUtils.toJsonString(pageInfo)
        ).build()
    }
